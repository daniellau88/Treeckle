...
export default function UserSelfNameChanger() {
    ...
    const handleNameEdit = () => {        
        axios.patch("api/accounts/profileName", { newName: state.editValue } , {
    ...
    return (
        <Grid columns={2}>
            <Grid.Column width={14} >
                ...
                defaultValue= {context.name} />) : <p style={{fontSize: "1.75em", fontWeight:"bold", wordWrap: "break-word"}}>{context.name}</p>}
            </Grid.Column>
            <Grid.Column width={2}>                    
                <Icon edit name="edit" onClick={handleEditActivate} 
                    style= {{
                        marginTop: "0.5rem",
                        top: "50%",
                        cursor: "pointer"
